 ...
 * @see https://gist.github.com/kevinsdooapp/3227204
  */
public class LogarithmicAxis extends ValueAxis<Number> {
    ...
    private static final Logger log = Logger.getLogger(LogarithmicAxis.class.getName());
    ...
    public LogarithmicAxis(double lowerBound, double upperBound) {
        ...
        try {
            ...
            log.log(Level.WARNING, "log exception with bounds "+lowerBound+" / "+upperBound, e);
        }
    }
    ...
    protected List<Number> calculateMinorTickMarks() {
        ...
        if (range != null) {
            ...
            double myLogUpperBound = Math.log10(upperBound.doubleValue());
            int minorTickMarkCount = getMinorTickCount();

            for (double i = 0; i <= myLogUpperBound; i += 1) {
    ...
    protected List<Number> calculateTickValues(double length, Object range) {
        ...
        if (range != null) {
            ...
            double myLogLowerBound = Math.log10(lowerBound.doubleValue());
            double myLogUpperBound = Math.log10(upperBound.doubleValue());
...
class IllegalLogarithmicRangeException extends IllegalArgumentException {

    public IllegalLogarithmicRangeException(String s) {
        super(s);
    }
}
